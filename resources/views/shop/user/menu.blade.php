            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li><a href="{{url('/')}}"><i class="fa fa-user fa-fw"></i> Home</a>
                        </li>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="{{url('shop/dashboard')}}"><i class="fa fa-dashboard fa-fw"></i> Dashboard: Shop Owner</a>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{url('shop/product-type')}}">Add Product</a>
                                </li>
                                <li>
                                    <a href="{{url('shop/product')}}">All Product</a>
                                </li>
                            </ul>
                        </li>
