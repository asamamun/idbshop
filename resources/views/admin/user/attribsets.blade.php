            ...
            <div class="panel panel-info" id="attribsetform">
                ...
                <div class="panel-body">
                    <form id="form" class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="col-md-6">
                        <button type="button" class="btn btn-info btn-xs" data-toggle="modal" data-target="#example">Choose Attributes</button>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">	
		<button type="button" class="btn btn-warning btn-sm" id="addbtn" data-dismiss="modal">Add</button>
        <button type="button" class="btn btn-warning btn-sm" id="updatebtn" data-dismiss="modal">Update</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
